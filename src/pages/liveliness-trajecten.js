  ...
  <Layout>
    ...
    <Section className="mb-20">
      ...
      <div className="text-left">
        ...
        Met de nieuwste inzichten, ondersteund door onderzoek, is de unieke aanpak van het 6 domeinen model ontstaan. Ik pas dit model toe in de liveliness trajecten, om samen met jou een omkeer in je leven te maken zodat jij je optimale zelf kunt zijn.</p>
        <h2>Wat is je optimale zelf?</h2>
        <p>Je optimale zelf heeft een gezond lichaam &amp; geest met voldoende energie, weinig tot geen kwaaltjes of ziektes, is dagelijks in beweging en slaapt goed.<br/><br/>
        ...
        - Darmklachten en huidproblemen</p>
      </div>
    </Section>
