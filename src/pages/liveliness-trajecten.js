...
const LivelinessPage = ({ data: { JumbotronImage, SelinaLivelinessPhoto, Testimonials } }) => (
  <Layout>
    ...
    <Section className="mb-20">
      <p>
        Even tijd voor jezelf, zorgen dat jij op nummer 1 staat. Investeren in jezelf omdat jij het waard bent. Kijkend vanuit een totaal plaatje en jou als uniek persoon wil ik je graag kennis laten maken met mijn Liveliness Traject. Tijdens zo’n traject zullen we in een korte tijd kennis opdoen, verbanden leggen en resultaat behalen zodat jij je optimale zelf kunt zijn.
      </p>
      <div className="text-left">
        <h2>Terug naar de basis</h2>
        <p>
          Tijdens het liveliness traject gaan we terug naar de B.A.S.I.S. Deze bekijken we vanuit het 6 domeinenmodel. We gaan hierbij dieper in op Bewegen, Ademhalen, Slapen, Immuunsysteem, Stress en zeker niet onbelangrijk is nummer zes; Voeding. Ons lichaam is mega fascinerend, omdat al deze 6 domeinen met elkaar samenwerken. Het kun dus zomaar zijn dat je bewust slechts een van deze domeinen aan hoeft te pakken, waardoor de overige domeinen zichzelf herstellen. Hoe ingenieus?!<br /><br />
          Dit ziet er bijvoorbeeld als volgt uit: Je stopt met het eten van bewerkt voedsel, waardoor je immuunsysteem herstelt. Je kunt vervolgens beter slapen en ervaart hierdoor meer energie. Door het sneeuwbaleffect in verschillende domeinen herstel je sneller en beter.<br /><br />
          Met de nieuwste inzichten, ondersteund door onderzoek, is de unieke aanpak van het 6 domeinen model ontstaan. Ik pas dit model toe in de liveliness trajecten, om samen met jou een omkeer in je leven te maken zodat jij je optimale zelf kunt zijn.
        </p>
        <h2>Wat is je optimale zelf?</h2>
        <p>
          Je optimale zelf heeft een gezond lichaam &amp; geest met voldoende energie, weinig tot geen kwaaltjes of ziektes, is dagelijks in beweging en slaapt goed.<br /><br />
          Wanneer je niet je optimale zelf bent kun je bijvoorbeeld het volgende ervaren:<br />
          - Geen energie<br />
          - Veel ziek, fysieke klachten of van kwaal in kwaal stappen<br />
          - Darmklachten en huidproblemen
        </p>
      </div>
    </Section>
    ...
    <Section colour="bg-grey text-white" className="flex flex-col lg:flex-row items-center justify-center text-left">
      <div>
        ...
        <p>
          Tijdens een liveliness traject sta je er niet alleen voor. Ik begeleid je tijdens het gehele proces en we stellen een plan op dat bij jou past en waar jij je in kunt vinden. Met een liveliness traject krijg je:
        </p>
    ...
    <Section colour="bg-olive" >
      ...
      <p>
        Heb jij fysieke klachten? En wil je er nu echt van af?<br />Maak een afspraak en dan gaan we samen met die puzzel aan de slag.
      </p>
